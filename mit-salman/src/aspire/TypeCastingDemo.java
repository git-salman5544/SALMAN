...
public static void main(String[] args) {
	byte b=120;//8 bit
	short s=b;//this is 100% compatible-because lower can easily fit higher type
	...
	System.out.println(b);
	//java divides the number by 256(size of byte)and the remainder is given as value
	
	/*
	 * when you do a downcasting that is from a higher to a lower
	 * if the value is acceptable then is assigns the value
	 * if the value i higher then it does a mathematical calculation and reduces the value
