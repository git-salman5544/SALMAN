...
public static void main(String[] args) {
	...
	//NUMBER TYPES
	byte weightr=100;// value 100 is assigned to a variable weight of type byte
	...
	float price=233;
	price=343434.45F;//mandatory to give F for value which has a decimal
	
	//64 bit
	duble highValue=34344.4545;
	...
	understood=false;
	//only two value either true\false can be given to variables
